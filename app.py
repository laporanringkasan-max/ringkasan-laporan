    ...
    if sales and not sales.df.empty:
        ...
        if not col_user_sales:
            ...
            if mode == "Data Penjualan Affiliator":
                ...
                cols_need = [
                    "Username",
                    "Perjanjian Video", col_vid_disp,     # col_vid_disp = "Video dibuat"
                    "Perjanjian Live",  col_live_disp,    # col_live_disp = "Live dilakukan"
                    "Tanggal Barang Diterima",
                ]
                ...
                if len(cols_exist) < 3:
                    ...
                    styler_kew = (
                        ...
                        .apply(_style_target_row_disp, axis=1)  # reuse highlight target logic
                    )
